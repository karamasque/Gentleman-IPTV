...
import com.kaynanamtv.domain.manager.ValidatedJellyfinProviderInput
import com.kaynanamtv.domain.manager.ValidatedJellyfinQuickConnectProviderInput
import com.kaynanamtv.domain.model.Program
import com.kaynanamtv.domain.manager.ValidatedM3uProviderInput
import com.kaynanamtv.domain.manager.ValidatedStalkerProviderInput
import com.kaynanamtv.domain.manager.ValidatedXtreamProviderInput
            ...
            providerSetupInputValidator = FakeProviderSetupInputValidator(
                xtreamResult = Result.success(
                    ValidatedXtreamProviderInput(
                        ...
                        name = "Premium",
                        httpUserAgent = "KaynanamTVTest/1.0",
...
private class FakeProviderRepository : ProviderRepository {
    ...
    override suspend fun getProviderCleartextPassword(id: Long): String? = null
