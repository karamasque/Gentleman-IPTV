...
import com.kaynanamtv.domain.model.VirtualGroup
...
class GetCustomCategoriesTest {
    ...
    private class FakeChannelRepository(
        ...
        override fun getCategories(providerId: Long): Flow<List<com.kaynanamtv.domain.model.Category>> = error("Not used in test")
