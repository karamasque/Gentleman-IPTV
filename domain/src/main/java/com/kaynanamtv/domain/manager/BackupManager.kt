...
data class BackupData(
    ...
    val favorites: List<com.kaynanamtv.domain.model.Favorite>? = null,
    val virtualGroups: List<com.kaynanamtv.domain.model.VirtualGroup>? = null,
...
interface BackupManager {
     ...
     */
    suspend fun exportConfig(uriString: String): com.kaynanamtv.domain.model.Result<Unit>
