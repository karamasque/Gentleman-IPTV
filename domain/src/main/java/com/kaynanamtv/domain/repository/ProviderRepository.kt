...
interface ProviderRepository {
    ...
    /**
     * Returns the decrypted (cleartext) password for a single provider.
     * Intended exclusively for pre-filling the edit form. Decryption
     * happens inside the `:data` layer.
     * Returns null if the provider is not found or decryption fails.
     */
    suspend fun getProviderCleartextPassword(id: Long): String?
