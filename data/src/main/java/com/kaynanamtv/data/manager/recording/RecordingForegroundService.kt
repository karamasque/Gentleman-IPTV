...
class RecordingForegroundService : Service() {
    ...
    private fun buildNotification(activeCount: Int, pendingCommand: Boolean): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentTitle("KaynanamTV DVR")
    ...
    companion object {
        private const val CHANNEL_ID = "kaynanamtv_recording"
        private const val NOTIFICATION_ID = 4102
        private const val IDLE_GRACE_MS = 3_000L
        private const val ACTION_START_CAPTURE = "com.kaynanamtv.data.recording.service.START_CAPTURE"
        private const val ACTION_STOP_CAPTURE = "com.kaynanamtv.data.recording.service.STOP_CAPTURE"
        private const val ACTION_RECONCILE = "com.kaynanamtv.data.recording.service.RECONCILE"
        private const val ACTION_EVALUATE_IDLE = "com.kaynanamtv.data.recording.service.EVALUATE_IDLE"
