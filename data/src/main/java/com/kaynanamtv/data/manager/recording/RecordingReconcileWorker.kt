...
class RecordingReconcileWorker(
    ...
    interface RecordingWorkerEntryPoint {
        fun recordingManager(): com.kaynanamtv.domain.manager.RecordingManager
    }
    ...
    override suspend fun doWork(): Result {
        ...
        return when (manager.reconcileRecordingState()) {
            is com.kaynanamtv.domain.model.Result.Success -> Result.success()
            is com.kaynanamtv.domain.model.Result.Error -> Result.retry()
            com.kaynanamtv.domain.model.Result.Loading -> Result.retry()
        }
    }
