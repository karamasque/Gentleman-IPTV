...
internal data class CatalogSyncRuntimeProfile(
    ...
    companion object {
        ...
        private const val LOW_STAGE_BATCH_SIZE = 250
        private const val MID_STAGE_BATCH_SIZE = 500
        private const val HIGH_STAGE_BATCH_SIZE = 1000
    }
}
