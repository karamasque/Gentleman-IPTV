package com.kaynanamtv.data.remote.http
...
const val DEFAULT_IPTV_USER_AGENT = "IPTVSmarters/3.1.2 (Linux; Android 12)"

fun buildAppUserAgent(versionName: String?): String {
    return DEFAULT_IPTV_USER_AGENT
}
...
fun buildGenericProviderRequestProfile(
    ...
    userAgent = httpUserAgent.trim().ifBlank { DEFAULT_IPTV_USER_AGENT },
