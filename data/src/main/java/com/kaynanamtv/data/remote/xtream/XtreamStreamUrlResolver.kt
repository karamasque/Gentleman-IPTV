...
import com.kaynanamtv.data.remote.jellyfin.buildJellyfinAuthorizationHeader
...
import com.kaynanamtv.data.remote.stalker.StalkerPlaybackResolutionException
...
import com.kaynanamtv.data.remote.stalker.buildStalkerPlaybackDescriptor
...
class XtreamStreamUrlResolver @Inject constructor(
        ...
        return when (resolvedProvider.type) {
            ...
            ProviderType.STALKER_PORTAL -> {
                ...
                val playbackInfo = when (
                    ...
                    is com.kaynanamtv.domain.model.Result.Success -> resolvedResult.data
                    is com.kaynanamtv.domain.model.Result.Error -> throw StalkerPlaybackResolutionException(
    ...
    private suspend fun resolveDirectStalkerUrl(
        ...
        val descriptor = buildStalkerPlaybackDescriptor(
            ...
            capabilities = com.kaynanamtv.data.remote.stalker.StalkerPortalCapabilities()
        )
    ...
    private suspend fun persistStalkerPlaybackLearning(
        provider: ProviderEntity,
        playbackInfo: com.kaynanamtv.data.remote.stalker.StalkerPlaybackInfo
    ) {
