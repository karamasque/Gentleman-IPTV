...
import com.kaynanamtv.data.local.entity.EpisodeBrowseEntity
import com.kaynanamtv.data.local.entity.EpisodeEntity
import com.kaynanamtv.data.local.entity.SeriesEntity
import com.kaynanamtv.data.local.entity.SeriesBrowseEntity
...
import com.kaynanamtv.data.remote.dto.XtreamSeason
...
import com.kaynanamtv.data.remote.stalker.StalkerEpisodeRecord
...
import com.kaynanamtv.data.remote.stalker.StalkerSeasonRecord
import com.kaynanamtv.data.remote.stalker.StalkerSeriesDetails
...
import com.kaynanamtv.domain.model.VodDuplicateConfidence
import com.kaynanamtv.domain.model.VodDuplicateHandlingMode
import com.kaynanamtv.domain.model.VodSeriesVariant
...
class SeriesRepositoryImplTest {
    ...
    fun `stalker series preview loads only first page`() = runTest {
        ...
        whenever(categoryDao.getByProviderAndType(7L, ContentType.SERIES.name)).thenReturn(
            flowOf(listOf(com.kaynanamtv.data.local.entity.CategoryEntity(providerId = 7L, categoryId = 77L, name = "Drama", type = ContentType.SERIES)))
        )
        whenever(providerDao.getById(7L)).thenReturn(
            ProviderEntity(
                id = 7L,
