package com.kaynanamtv.data.local
...
class KaynanamTVDatabaseMigrationTest {

    private val testDbName = "kaynanamtv-migration-test"
    ...
    fun migrate1To42_fullChainValidatesLatestSchema() {
        migrationTestHelper.createDatabase("kaynanamtv-full-chain-test", 1).close()

        migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-full-chain-test",
            42,
            true,
    ...
    fun migrate44To51_publicMasterUpgradeValidatesLatestSchema() {
        migrationTestHelper.createDatabase("kaynanamtv-public-master-44-51-test", 44).apply {
            execSQL(
                """
        ...
        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-public-master-44-51-test",
            52,
            true,
    ...
    fun migrate48To49_addsProviderHttpProfileColumns() {
        migrationTestHelper.createDatabase("kaynanamtv-48-49-test", 48).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate49To50_createsXtreamLiveOnboardingStateTable() {
        migrationTestHelper.createDatabase("kaynanamtv-49-50-test", 49).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-49-50-test",
            50,
            true,
            KaynanamTVDatabase.MIGRATION_49_50
        )
    ...
    fun migrate50To51_addsXtreamLiveOnboardingProfileDiagnostics() {
        migrationTestHelper.createDatabase("kaynanamtv-50-51-test", 50).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-50-51-test",
            51,
            true,
            KaynanamTVDatabase.MIGRATION_50_51
        )
    ...
    fun migrate51To52_addsXtreamLiveSyncMode() {
        migrationTestHelper.createDatabase("kaynanamtv-51-52-test", 51).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-51-52-test",
            52,
            true,
            KaynanamTVDatabase.MIGRATION_51_52
        )
    ...
    fun migrate52To53_addsStalkerHardeningHydrationColumns() {
        migrationTestHelper.createDatabase("kaynanamtv-52-53-test", 52).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-52-53-test",
            53,
            true,
    ...
    fun migrate53To54_addsStalkerIdentityColumns() {
        migrationTestHelper.createDatabase("kaynanamtv-53-54-test", 53).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate40To41_addsAudioVideoOffsetColumn() {
        migrationTestHelper.createDatabase("kaynanamtv-40-41-test", 40).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-40-41-test",
            41,
            true,
            KaynanamTVDatabase.MIGRATION_40_41
        )
    ...
    fun migrate41To42_createsPlaybackCompatibilityRecordsTable() {
        migrationTestHelper.createDatabase("kaynanamtv-41-42-test", 41).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-41-42-test",
            42,
            true,
            KaynanamTVDatabase.MIGRATION_41_42
        )
    ...
    fun migrate42To43_addsProviderSeriesIdColumn() {
        migrationTestHelper.createDatabase("kaynanamtv-42-43-test", 42).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-42-43-test",
            43,
            true,
            KaynanamTVDatabase.MIGRATION_42_43
        )
    ...
    fun migrate43To44_addsPagedVodHydrationColumns() {
        migrationTestHelper.createDatabase("kaynanamtv-43-44-test", 43).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-43-44-test",
            44,
            true,
            KaynanamTVDatabase.MIGRATION_43_44
        )
    ...
    fun migrate38To39_addsStalkerProviderColumnsAndUniqueIndex() {
        migrationTestHelper.createDatabase("kaynanamtv-38-39-test", 38).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate32To33_backfillsMovieWatchCountAndAddsGlobalFavoritesIndex() {
        migrationTestHelper.createDatabase("kaynanamtv-32-33-test", 32).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate33To34_addsSuccessTimestampsAndProgramsEndTimeIndex() {
        migrationTestHelper.createDatabase("kaynanamtv-33-34-test", 33).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate44To45_dedupesGlobalFavoritesAndAddsNullSafeUniqueKey() {
        migrationTestHelper.createDatabase("kaynanamtv-44-45-test", 44).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate45To46_rebuildsSeriesStageWithProviderSeriesKey() {
        migrationTestHelper.createDatabase("kaynanamtv-45-46-test", 45).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate46To47_createsBrowseQueryIndexes() {
        migrationTestHelper.createDatabase("kaynanamtv-46-47-test", 46).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-46-47-test",
            47,
            true,
            KaynanamTVDatabase.MIGRATION_46_47
        )
    ...
    fun migrate47To48_createsXtreamIndexBackfillsRowsAndMarksSummaryState() {
        migrationTestHelper.createDatabase("kaynanamtv-47-48-test", 47).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate34To35_createsSearchHistoryTable() {
        migrationTestHelper.createDatabase("kaynanamtv-34-35-test", 34).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-34-35-test",
            35,
            true,
            KaynanamTVDatabase.MIGRATION_34_35
        )
    ...
    fun migrate31To32_scopesFavoritesAndSplitsMixedProviderGroups() {
        migrationTestHelper.createDatabase("kaynanamtv-31-32-test", 31).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate31To32_assignsLegacyGroupsWhenNoProviderIsActive() {
        migrationTestHelper.createDatabase("kaynanamtv-31-32-no-active-test", 31).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
        ...
        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-31-32-no-active-test",
            32,
            true,
            KaynanamTVDatabase.MIGRATION_31_32
        )
    ...
    fun migrate35To36_addsProgramRemindersAndEpgMatchMetadata() {
        migrationTestHelper.createDatabase("kaynanamtv-35-36-test", 35).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-35-36-test",
            36,
            true,
            KaynanamTVDatabase.MIGRATION_35_36
        )
    ...
    fun migrate36To37_createsTmdbIdentityTable() {
        migrationTestHelper.createDatabase("kaynanamtv-36-37-test", 36).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate14To15_addsAuditCompletionColumns() {
        migrationTestHelper.createDatabase("kaynanamtv-14-15-test", 14).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate59To60_addsDownloadSourceColumns() {
        migrationTestHelper.createDatabase("kaynanamtv-59-60-test", 59).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-59-60-test",
            60,
            true,
    ...
    fun migrate57To61_upgradeChainValidatesLatestSchema() {
        migrationTestHelper.createDatabase("kaynanamtv-57-61-test", 57).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-57-61-test",
            61,
            true,
    ...
    fun migrate60To61_release114To115UpgradePreservesProviders() {
        migrationTestHelper.createDatabase("kaynanamtv-release-114-115-test", 60).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
        ...
        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-release-114-115-test",
            61,
            true,
            KaynanamTVDatabase.MIGRATION_60_61
        )
    ...
    fun migrate60To61_addsStalkerAdvancedOptionsJson() {
        migrationTestHelper.createDatabase("kaynanamtv-60-61-test", 60).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-60-61-test",
            61,
            true,
            KaynanamTVDatabase.MIGRATION_60_61
        )
    ...
    @Test
    fun migrate62To63() {
        migrationTestHelper.createDatabase("kaynanamtv-62-63-test", 62).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "kaynanamtv-62-63-test",
            63,
            true,
