...
internal object PlaybackBufferPolicies {
    ...
    private const val MPEG_TS_LIVE_MAX_BUFFER_MS = 25_000

    private const val LOW_MEMORY_LIVE_MIN_BUFFER_MS = 8_000
    private const val LOW_MEMORY_LIVE_MAX_BUFFER_MS = 25_000
    ...
    private const val LIVE_MAX_BUFFER_MS = 25_000
    ...
    private const val REBUFFER_MS = 3_000
    private const val VOD_PLAYBACK_BUFFER_MS = 750
    private const val VOD_REBUFFER_MS = 2_000
    ...
    private const val LARGE_LIVE_MAX_BUFFER_MS = 25_000
    private const val LARGE_LIVE_PLAYBACK_BUFFER_MS = 750
