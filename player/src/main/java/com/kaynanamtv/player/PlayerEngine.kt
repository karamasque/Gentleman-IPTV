...
interface PlayerEngine {
    ...
    /**
     * Kayıt başlat: mevcut stream verisi oynatılırken aynı anda [sink]'e yazılır.
     * Sunucuya ayrı bir HTTP isteği atılmaz — ExoPlayer'ın açık bağlantısı kullanılır.
     * @return true: kayıt başarıyla başlatıldı, false: player hazır değil
     */
    fun startTeeCapture(sink: OutputStream): Boolean

    /**
     * Kayıt durdur: [sink] flush edilip kapatılır, oynatma normal devam eder.
     */
    fun stopTeeCapture()
