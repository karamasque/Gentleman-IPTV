...
release_body = (
    "KaynanamTV v1.1.66 (Zorunlu Güncelleme)\n\n"
    "### 🚀 Cihaz Zekalı Roket / Performans Modu (Otomatik Donanım Algılama)\n"
    "- **Akıllı Donanım Tespiti:** Cihazın RAM miktarı, CPU çekirdek sayısı ve TV kutusu donanım seviyesi analiz edilerek düşük/orta seviye cihazlarda **Roket Modu** otomatik olarak devreye alınır.\n"
    "- **Sıfır GPU/CPU Readback:** Roket Modu devredeyken video karesi örnekleme döngüsü kapatılarak işlemci ve grafik kartı üzerindeki ağır yük tamamen sıfırlandı; menüler ve kanal listesi kaydırmaları 60 FPS ultra akıcı hale getirildi.\n"
    "- **Düşük Bellek Optimizasyonu:** Görsel işleme ve önbellek yönetimi düşük RAM'li cihazlar için optimize edilerek Android Garbage Collector kaynaklı mikro takılmalar ortadan kaldırıldı.\n"
    "- **Ayarlar Menüsü:** `Ayarlar > Temel Oynatma Ayarları` menüsüne `Roket / Performans Modu` [Otomatik / Her Zaman Açık / Kapalı] seçeneği eklendi.\n\n"
    "### ⚡ Oynatıcı Kararlılığı ve Güvenliği\n"
    "- Video oynatıcı ve kanal zaplama katmanı Media3 (ExoPlayer) motorunda %100 orijinal kararlılığıyla korunmuştur."
)
