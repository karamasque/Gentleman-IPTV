...
release_body = (
    "KaynanamTV v1.1.13\n\n"
    "- Black temada 'Bağlan' butonunun okunabilirlik ve kontrast sorunu onPrimary semantic token ile düzeltildi.\n"
    "- Aktif sağlayıcı rozeti yeşil/success renk temasına geçirildi.\n"
    "- Sağlayıcı kartındaki mükerrer raw 'ACTIVE' durum metni kaldırılarak temiz tip etiketi sağlandı.\n"
    "- Canlı TV zap ve kanal geçişlerinde generic 'Kanal X' yerine gerçek kanal isimleri ve temiz numaralandırma getirildi.\n"
    "- Canlı TV kartlarındaki gereksiz 'YAKALAN' rozeti kaldırıldı ve 'Tekrar İzle' / 'Geri Sarma' terminolojisi %100 Türkçeleştirildi."
)
...
with urllib.request.urlopen(req_upload) as resp_upload:
    ...
    print(f"🎉 Asset Uploaded Successfully! Download URL: {res['browser_download_url']}")
