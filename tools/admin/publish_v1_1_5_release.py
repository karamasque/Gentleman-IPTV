...
data = {
    ...
    "body": "KaynanamTV v1.1.5 Zorunlu Güncelleme\n\n- P0 Account-Bound Provider Cloud Sync & Reinstall Restore Düzeltmesi (Premium şartı kaldırılarak tüm Firebase kullanıcılarının IPTV sağlayıcı bulut yedekleme ve temiz kurulum geri yükleme desteği sağlandı).\n- Strict 'REMOTE DELETE = EXPLICIT USER PROVIDER DELETE ONLY' kuralı korundu.\n- Detaylı yaşam döngüsü runtime logları eklendi.",
    "draft": False,
    "prerelease": False
}
