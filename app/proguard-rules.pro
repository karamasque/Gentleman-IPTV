...
-keepclassmembers class com.kaynanamtv.data.remote.** { <fields>; }
...
-keep class com.kaynanamtv.domain.model.** { *; }
-keep class com.kaynanamtv.data.local.entity.** { *; }
-keep class com.kaynanamtv.data.remote.xtream.model.** { *; }
-keep class com.kaynanamtv.app.ui.screens.update.** { *; }
-keep class com.kaynanamtv.data.repository.RemoteConfigRepositoryImpl { *; }

# ── Security / TLS ──────────────────────────────────────────
-keepnames class com.kaynanamtv.data.security.CredentialCrypto
-keepclassmembers class com.kaynanamtv.data.security.CredentialCrypto {
    <fields>;
    <methods>;
}
