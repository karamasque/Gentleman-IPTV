package com.kaynanamtv.app.tvinput
...
@AndroidEntryPoint
class KaynanamTVTvInputService : TvInputService() {
    ...
    override fun onCreateSession(inputId: String): Session = KaynanamTVSession(this)

    private inner class KaynanamTVSession(context: Context) : Session(context) {
    ...
    private companion object {
        const val TAG = "KaynanamTVTvInput"
        const val DEFAULT_USER_AGENT = "KaynanamTVTvInput"
