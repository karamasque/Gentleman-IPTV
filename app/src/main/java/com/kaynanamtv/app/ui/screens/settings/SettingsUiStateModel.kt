...
data class SettingsUiState(
    ...
    val guideDefaultCategoryId: Long = com.kaynanamtv.domain.model.VirtualCategoryIds.FAVORITES,
    ...
    val epgSources: List<com.kaynanamtv.domain.model.EpgSource> = emptyList(),
    val epgSourceAssignments: Map<Long, List<com.kaynanamtv.domain.model.ProviderEpgSourceAssignment>> = emptyMap(),
