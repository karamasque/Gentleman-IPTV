...
import com.kaynanamtv.app.ui.components.SavedCategoryContextCard
import com.kaynanamtv.app.ui.components.SavedCategoryShortcut
import com.kaynanamtv.app.ui.components.SavedCategoryShortcutsRow
import com.kaynanamtv.app.ui.components.SelectionChip
import com.kaynanamtv.app.ui.components.SelectionChipRow
...
import com.kaynanamtv.app.ui.components.ReorderTopBar
import com.kaynanamtv.app.ui.components.dialogs.DeleteGroupDialog
import com.kaynanamtv.app.ui.components.dialogs.RenameGroupDialog
import com.kaynanamtv.app.ui.components.shell.BrowseHeroPanel
import com.kaynanamtv.app.ui.components.shell.BrowseSearchLaunchCard
import com.kaynanamtv.app.ui.components.shell.LoadMoreCard
import com.kaynanamtv.app.ui.components.shell.InfiniteScrollEffect
import com.kaynanamtv.app.ui.components.shell.AppNavigationChrome
import com.kaynanamtv.app.ui.components.shell.AppMessageState
import com.kaynanamtv.app.ui.components.shell.AppScreenScaffold
import com.kaynanamtv.app.ui.components.shell.VodActionChip
import com.kaynanamtv.app.ui.components.shell.VodActionChipRow
import com.kaynanamtv.app.ui.components.shell.VodCategoryOption
import com.kaynanamtv.app.ui.components.shell.VodCategoryPickerDialog
import com.kaynanamtv.app.ui.components.shell.VodBrowseOptionsDialog
import com.kaynanamtv.app.ui.components.shell.VodClassicCategoryOption
import com.kaynanamtv.app.ui.components.shell.VodClassicContentHeader
import com.kaynanamtv.app.ui.components.shell.VodClassicSplitLayout
import com.kaynanamtv.app.ui.components.shell.VodHeroStrip
import com.kaynanamtv.app.ui.components.shell.VodSectionHeader
import com.kaynanamtv.app.ui.design.FocusRestoreHost
import com.kaynanamtv.app.ui.design.requestFocusSafely
import com.kaynanamtv.app.ui.model.VodViewMode
import com.kaynanamtv.app.ui.screens.vod.HandleVodUserMessage
import com.kaynanamtv.app.ui.screens.vod.ProtectedVodPinDialog
import com.kaynanamtv.app.ui.screens.vod.VodBrowseDefaults
import com.kaynanamtv.app.ui.screens.vod.vodActiveFilterSortDetail
...
fun SeriesScreen(
    ...
    if (uiState.showDialog && uiState.selectedSeriesForDialog != null) {
        val series = uiState.selectedSeriesForDialog ?: return
        com.kaynanamtv.app.ui.components.dialogs.AddToGroupDialog(
    ...
    if (uiState.selectedCategoryForOptions != null) {
        val category = uiState.selectedCategoryForOptions ?: return
        com.kaynanamtv.app.ui.components.dialogs.CategoryOptionsDialog(
            category = category,
        ...
        if (uiState.isLoadingSelectedCategory) {
            ...
            item(span = { GridItemSpan(maxLineSpan) }) {
                Box(
                    ...
                    AppMessageState(
                        title = if (uiState.hasProviders && uiState.categories.isEmpty() && filteredGridSeries.isEmpty()) {
                            "İçerikler hazırlanıyor…"
                        } else {
                            stringResource(R.string.series_no_found)
                        },
                        subtitle = if (uiState.hasProviders && uiState.categories.isEmpty() && filteredGridSeries.isEmpty()) {
                            "Diziler arka planda indiriliyor ve hazırlanıyor, lütfen birazdan tekrar kontrol edin."
                        } else {
                            stringResource(R.string.series_no_found_subtitle)
                        }
                    )
                }
            }
...
private fun seriesFilterChips(): List<SelectionChip> {
    return listOf(
        SelectionChip(LibraryFilterType.ALL.name, "Tümü"),
        SelectionChip(LibraryFilterType.FAVORITES.name, "Favoriler"),
        SelectionChip(LibraryFilterType.IN_PROGRESS.name, "Devam Et"),
        SelectionChip(LibraryFilterType.UNWATCHED.name, "İzlenmeyenler"),
        SelectionChip(LibraryFilterType.RECENTLY_UPDATED.name, "Son Güncellenenler"),
        SelectionChip(LibraryFilterType.TOP_RATED.name, "En Beğenilenler")
    )
}
...
private fun seriesSortChips(): List<SelectionChip> {
    return LibrarySortBy.entries.map { sort ->
        SelectionChip(
            key = sort.name,
            label = when (sort) {
                LibrarySortBy.LIBRARY -> "Varsayılan Sıralama"
                LibrarySortBy.TITLE -> "A-Z"
                LibrarySortBy.RELEASE -> "En Yeni"
                LibrarySortBy.UPDATED -> "Son Güncellenenler"
