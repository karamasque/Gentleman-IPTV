    ...
    androidx.compose.foundation.layout.Box(
        ...
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            if (assignments.isEmpty()) {
                Text("Atanmış EPG kaynağı yok", style = MaterialTheme.typography.bodySmall, color = OnSurfaceDim)
            } else {
...
private fun ProviderEpgAssignmentRow(
    ...
    Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.fillMaxWidth()) {
        ...
        TvClickableSurface(
            ...
            Text("Kaldır", modifier = Modifier.padding(horizontal = 8.dp, vertical = 4.dp), style = MaterialTheme.typography.labelSmall, color = Color(0xFFEF5350))
        }
    }
}
