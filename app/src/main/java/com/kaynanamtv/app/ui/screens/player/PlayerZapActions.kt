...
internal fun PlayerViewModel.executeChannelChange(index: Int, userInitiated: Boolean = true, source: String = "execute") {
    ...
    viewModelScope.launch {
        ...
        playerEngine.playbackState
            .filter {
                it == com.kaynanamtv.player.PlaybackState.READY ||
...
internal fun PlayerViewModel.recordLivePlayback(channel: com.kaynanamtv.domain.model.Channel) {
...
internal fun PlayerViewModel.resolveChannelByNumber(number: Int?): com.kaynanamtv.domain.model.Channel? {
    if (number == null) return null
    return channelNumberIndex[number]
}

internal fun PlayerViewModel.resolveChannelByPrefix(prefix: String): com.kaynanamtv.domain.model.Channel? {
