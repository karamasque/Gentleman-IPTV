...
internal class SettingsSyncActions(
                ...
                if (result is Result.Error) {
                    ...
                    state.copy(
                        ...
                        userMessage = if (updatedWarnings.isEmpty()) {
                            "Bölüm yeniden denemesi başarılı oldu. Tüm mevcut uyarılar temizlendi."
                        } else {
                            "Bölüm yeniden denemesi başarılı oldu."
                        },
    ...
    private fun ProviderSyncSelection.completionLabel(isXtream: Boolean): String = when {
        isXtream && this == ProviderSyncSelection.MOVIES -> "Film dizini sıraya alındı"
        isXtream && this == ProviderSyncSelection.SERIES -> "Dizi dizini sıraya alındı"
