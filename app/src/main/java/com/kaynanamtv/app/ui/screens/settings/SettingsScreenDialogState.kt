...
internal class SettingsScreenDialogState(
    ...
    private val showVisualEffectsModeDialogState: MutableState<Boolean>,
    ...
    private val showStartupSoundDialogState: MutableState<Boolean>,
    ...
    var showVisualEffectsModeDialog by showVisualEffectsModeDialogState
    ...
    var showStartupSoundDialog by showStartupSoundDialogState
...
internal fun rememberSettingsScreenDialogState(): SettingsScreenDialogState {
    ...
    val showVisualEffectsModeDialogState = rememberSaveable { mutableStateOf(false) }
    ...
    val showStartupSoundDialogState = rememberSaveable { mutableStateOf(false) }
    ...
    return SettingsScreenDialogState(
        ...
        showVisualEffectsModeDialogState = showVisualEffectsModeDialogState,
        ...
        showStartupSoundDialogState = showStartupSoundDialogState,
