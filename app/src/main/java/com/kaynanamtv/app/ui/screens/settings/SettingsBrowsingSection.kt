...
import com.kaynanamtv.app.ui.theme.AccentCyan
import com.kaynanamtv.app.ui.theme.AccentGreen
import com.kaynanamtv.app.ui.theme.AccentRed
...
internal fun LazyListScope.settingsBrowsingSection(
    ...
    onShowStartupSoundDialogChange: (Boolean) -> Unit,
...
private val themeEntries = listOf(
    ThemeEntry(AppColorTheme.INDIGO, Color(0xFF6366F1), "İndigo"),
    ThemeEntry(AppColorTheme.BLACK,  Color(0xFF3A3A3A), "Siyah"),
    ThemeEntry(AppColorTheme.BLUE,   Color(0xFF3B82F6), "Mavi"),
    ThemeEntry(AppColorTheme.RED,    Color(0xFFEF4444), "Kırmızı"),
    ThemeEntry(AppColorTheme.YELLOW, Color(0xFFF59E0B), "Sarı"),
    ThemeEntry(AppColorTheme.GREEN,  Color(0xFF10B981), "Yeşil"),
    ThemeEntry(AppColorTheme.PURPLE, Color(0xFFA855F7), "Mor"),
    ThemeEntry(AppColorTheme.PINK,   Color(0xFFEC4899), "Pembe"),
)

@Composable
internal fun ThemeColorPickerRow(
    ...
    Column(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(
                    text = themeEntries.firstOrNull { it.theme == currentTheme }?.labelTr ?: "İndigo",
                    style = MaterialTheme.typography.bodySmall,
            ...
            Row(
                ...
                themeEntries.forEach { entry ->
                    ThemeColorDot(
                        entry = entry,
                        isSelected = currentTheme == entry.theme,
                        onSelected = { onThemeSelected(entry.theme) }
                    )
                }
            }
        }
