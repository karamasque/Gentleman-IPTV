 ...
 * The [formatUrl] is one of the [com.kaynanamtv.domain.model.ChannelQualityOption.url] values
 * from the channel's [com.kaynanamtv.domain.model.Channel.qualityOptions].
 */
