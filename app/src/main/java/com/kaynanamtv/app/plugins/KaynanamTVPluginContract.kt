...
object KaynanamTVPluginContract {
    const val API_VERSION = 1

    const val ACTION_PLUGIN_SERVICE = "com.kaynanamtv.plugin.API"
    const val META_MANIFEST_JSON = "com.kaynanamtv.plugin.MANIFEST_JSON"
    const val META_ID = "com.kaynanamtv.plugin.ID"
    const val META_NAME = "com.kaynanamtv.plugin.NAME"
    const val META_VERSION_NAME = "com.kaynanamtv.plugin.VERSION_NAME"
    const val META_VERSION_CODE = "com.kaynanamtv.plugin.VERSION_CODE"
    const val META_DESCRIPTION = "com.kaynanamtv.plugin.DESCRIPTION"
    const val META_CAPABILITIES = "com.kaynanamtv.plugin.CAPABILITIES"
    const val META_CONFIGURATION_MODE = "com.kaynanamtv.plugin.CONFIGURATION_MODE"
    const val META_CONFIGURATION_ACTIVITY_ACTION = "com.kaynanamtv.plugin.CONFIGURATION_ACTIVITY_ACTION"
    const val META_PROVIDER_NAME = "com.kaynanamtv.plugin.PROVIDER_NAME"
