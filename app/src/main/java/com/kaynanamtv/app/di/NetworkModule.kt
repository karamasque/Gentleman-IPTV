...
import com.kaynanamtv.data.remote.stalker.OkHttpStalkerApiService
...
object NetworkModule {
    ...
    fun provideOkHttpClient(
        ...
        return OkHttpClient.Builder()
            .cache(
                Cache(
                    directory = File(context.cacheDir, "kaynanamtv_http_cache"),
            ...
            .connectionPool(okhttp3.ConnectionPool(25, 10, java.util.concurrent.TimeUnit.MINUTES)) // Allow more idle connections
            .dispatcher(okhttp3.Dispatcher().apply {
                maxRequests = 128
                maxRequestsPerHost = 25 // Increase host limit for Multi-View and parallel queries
            })
            .build()
    }
