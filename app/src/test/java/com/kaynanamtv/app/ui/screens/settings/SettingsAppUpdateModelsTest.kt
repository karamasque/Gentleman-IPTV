...
import com.kaynanamtv.app.update.AppUpdateChannel
import com.kaynanamtv.app.update.AppUpdateDownloadStatus
import com.kaynanamtv.app.update.isRemoteVersionNewerForBuild
...
class SettingsAppUpdateModelsTest {
    ...
    fun downloadedLatestShowsInstallAction() {
        val update = AppUpdateUiModel(
            ...
            downloadUrl = "https://example.com/KaynanamTV.apk",
